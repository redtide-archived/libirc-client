...
*/
#ifndef IRC_IMPL_COMMAND_IPP
#define IRC_IMPL_COMMAND_IPP
...
// Converts an integral value to the enum type, checks to
// ensure value is in range assuming value is in the range of raw_command_t
command to_command( raw_command_t value )
{
    switch(value) {
    default:
        return command::RPL_NONE;
    ...
    case static_cast<raw_command_t>(command::invite):
